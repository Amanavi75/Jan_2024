          ...
          <div className="before:absolute before:top-0 before:bottom-0 before:left-4 lg:before:left-[21px] before:w-0.5 before:bg-white/10 before:backdrop-blur-sm">
            {timelineData.map((item, index) => (
              ...
              >
                ...
                <div className="bg-white/5 border border-white/10 backdrop-blur-md rounded-xl p-5 mt-2 shadow-sm transition-all w-5/12 sm:w-6/12 md:w-8/12 lg:w-full lg:max-w-full ">
